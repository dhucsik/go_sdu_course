...
func GenerateNewTokens(id string, userRole string) (*Tokens, error) {
	accessToken, err := generateNewAccessToken(id, userRole)
	if err != nil {
		return nil, err
	}
...
func generateNewAccessToken(id string, userRole string) (string, error) {
